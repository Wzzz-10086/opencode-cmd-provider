...
export const MODEL_SNAPSHOT: readonly CatalogModel[] = [
  ...
  { id: "moonshotai/Kimi-K3-drill", name: "Kimi K3", contextLength: 1000000, contextSource: "models.md", efforts: ["low","high","max"], cost: { input: 3, output: 15, cacheRead: 0.3, cacheWrite: 0 }, costSource: "models.md" },
